...
% Last Modified by GUIDE v2.5 19-Aug-2013 17:07:50
...
% --- Executes on selection change in popupmenuinput.
function popupmenuinput_Callback(hObject, eventdata, handles)
% hObject    handle to popupmenuinput (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns popupmenuinput contents as cell array
%        contents{get(hObject,'Value')} returns selected item from popupmenuinput
